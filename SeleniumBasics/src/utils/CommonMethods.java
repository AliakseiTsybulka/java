...
public class CommonMethods {
	...
	public static void switchToFrame(int index) {
		...
		WebElement found = driver.findElement(By.linkText(linkText));
		return found;
		}
		
		public static WebElement findByCSS(String css) {
			WebElement found = driver.findElement(By.cssSelector(css));
			return found;
			}
		...
		public static List<WebElement> findElements(String css) {
			List<WebElement> elements = driver.findElements(By.cssSelector(css));
			return elements;
		}
		
		public static void selectRB(List<WebElement> elements, String value) {
			for (WebElement ele : elements) {
				String text = ele.getText();
				if (ele.isDisplayed() && ele.isEnabled() && text.equals(value)) {
					ele.click();
				}
			}
		}
		
		public static void selectCB(List<WebElement> elements, String value) {
			for (WebElement ele : elements) {
				String text = ele.getText();
				if (ele.isDisplayed() && ele.isEnabled() && text.equals(value)) {
					ele.click();
		...
		public static void takesScreenshot(String folderName, String fileName) {
